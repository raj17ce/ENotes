...
<div class="container notes-container">
	...
	<form action="./addNotesServlet" method="post" class="notes-form">
		...
		<label for="ntitle">Enter Title</label>
		<input type="text" name="ntitle" placeholder="Add a title for your Note" required/>
		<label for="ncontent">Enter Content</label>
		<textarea name="ncontent" id="" cols="30" rows="13" placeholder="Add some content for your Note"></textarea>
